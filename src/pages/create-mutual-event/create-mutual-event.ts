      ...
      .subscribe(data =>
        loading.dismiss().then(() => {
          ...
          if (a.success == true) {
            ...
            let alert = this.alertCtrl.create({
              subTitle: this.translateService.instant('popup.Create_eventsss'),
              buttons: [this.translateService.instant('popup.ok')]
            });
            alert.present();
