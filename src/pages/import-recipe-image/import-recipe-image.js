...
var ImportRecipeImagePage = /** @class */ (function () {
    function ImportRecipeImagePage(transfer, file, loadingCtrl, imagePicker, alertCtrl, securityProvider, actionSheetCtrl, camera, navCtrl, navParams, popoverCtrl, viewCtrl) {
    ...
    ImportRecipeImagePage.prototype.onSave = function () {
        ...
        if (mandatoryfields.length > 0) {
            var alert_1 = this.alertCtrl.create({
                title: 'Alert!!',
                subTitle: 'Field required ' + mandatoryfields.join(','),
                buttons: ['OK']
            });
            alert_1.present();
        }
    ...
    ImportRecipeImagePage.prototype.presentActionSheet = function () {
        var _this = this;
