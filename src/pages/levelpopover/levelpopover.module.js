...
import { LevelpopoverPage } from './levelpopover';
var LevelpopoverPageModule = /** @class */ (function () {
    ...
    LevelpopoverPageModule = __decorate([
        NgModule({
            ...
            imports: [
                IonicPageModule.forChild(LevelpopoverPage),
            ],
        })
    ], LevelpopoverPageModule);
    return LevelpopoverPageModule;
}());
export { LevelpopoverPageModule };
