              ...
              if (a.success == true) {
                ...
                var mesaage = "Recipe Imported Successfully!"
                  let alert = this.alertCtrl.create({
                    subTitle: this.translateService.instant('popup.Recipe_Imported_Successfully'),
...
takePhoto() {
  ...
  onCancel() {
    let alert = this.alertCtrl.create({
      title: this.translateService.instant('popup.cancel_recipe'),
      buttons: [{
          text: this.translateService.instant('popup.Cancel'),
          role: 'cancel',
          handler: () => {
...
upload(message) {
    ...
    fileTransfer.upload(this.video, heroesUrl + 'recipeVideo/' + this.recipe_id, options)
      .then((data) => {
        ...
        loading.dismiss();
        let alert = this.alertCtrl.create({
          subTitle: this.translateService.instant('popup.'+message),
          buttons: [this.translateService.instant('popup.ok')]
        });
        alert.present();
