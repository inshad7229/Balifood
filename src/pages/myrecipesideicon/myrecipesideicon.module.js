...
import { MyrecipesideiconPage } from './myrecipesideicon';
var MyrecipesideiconPageModule = /** @class */ (function () {
    ...
    MyrecipesideiconPageModule = __decorate([
        NgModule({
            ...
            imports: [
                IonicPageModule.forChild(MyrecipesideiconPage),
            ],
        })
    ], MyrecipesideiconPageModule);
    return MyrecipesideiconPageModule;
}());
export { MyrecipesideiconPageModule };
